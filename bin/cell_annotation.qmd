...
seurat[["prediction.score.celltype.l1"]] <- NULL
seurat[["prediction.score.celltype.l2"]] <- NULL
seurat[["prediction.score.celltype.l3"]] <- NULL
...
dynamic_size <- function(data, base_width = 6) {
  base_height <- 4
  height <- base_height + nrow(data) * 0.1  # Example logic
